...
import { Input } from "../../Component/ui/product-ui/Input";
...
const ResetPasswordPage = () => {
  ...
  const { loading, error, message } = useSelector((state) => state.user); // update selector
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (resetPassword.fulfilled.match(resultAction)) {
        ...
        toast.error(resultAction.payload || "Error resetting password");
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${img})`, // Replace with your own image URL
      }}
    >
      <motion.div
