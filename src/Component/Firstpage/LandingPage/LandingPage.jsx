...
// import bg from "../../../assets/pexels-asphotograpy-1002703.jpg"

function LandingPage() {
  // Lines to be animated
  const lines = [
    "+2000 Agri Food Sellers",
    "Request Your Sample",
  ...
  useEffect(() => {
    // Set up an interval to cycle through the lines
      ...
      <div className="Background">
        <div className="main">
          ...
          <div className="left-side">
            <h1 className="title">
              A B2B MARKETPLACE WHERE FAIR CROP TRADING IS MADE EASY, FAST, AND
              TRANSPARENT!
            </h1>
            {/* Animated text */}
          ...
          <div className="right-side">
            <h1 className="title">Select a Product to Buy & Sell</h1>
            ...
            <p className="contact">
              <h3>Can’t find the Product you’re looking for? </h3>
              <button>
